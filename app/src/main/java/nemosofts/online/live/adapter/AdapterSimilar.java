...
public class AdapterSimilar extends RecyclerView.Adapter<AdapterSimilar.ViewHolder> {
    ...
    public AdapterSimilar(List<ItemData> arrayList, RecyclerItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_similar_v,parent, false);
