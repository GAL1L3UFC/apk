...
public class FragmentTrending extends Fragment {
    ...
    private void getData() {
        if (helper.isNetworkAvailable()) {
                            ...
                            if (!verifyStatus.equals("-1")) {
                                if (arrayListData.isEmpty()) {
                                    ...
                                    for (int i = 0; i < arrayListData.size(); i++) {
                                        ...
                                        if (Boolean.TRUE.equals(Callback.isNativeAdPost && Callback.isAdsStatus)) {
            ...
            }, helper.getAPIRequest(Callback.METHOD_MOST_VIEWED, 0, "", "", "", "", "", "", "", "", "", "", "", "", null));
    ...
    SearchView.OnQueryTextListener queryTextListener = new SearchView.OnQueryTextListener() {
        ...
        public boolean onQueryTextSubmit(String s) {
            ...
            FragmentSearchLive fsearch = new FragmentSearchLive();
